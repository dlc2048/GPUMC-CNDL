#!/usr/bin/env python3
"""calculate the number of neutron and proton
and calculate direction of seconary by the energy-momentum conservation
...
from lib.Python.constants import *
from lib.Python.endf_io import particle_type, reaction_multiplicity
...
def labMuCumul(mu, A, c):
    """get cumulative probability function of mu
